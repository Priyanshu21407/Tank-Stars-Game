...
public class choose_tank1 extends ScreenAdapter implements Screen {
...
// green
    public choose_tank1(MyGdxGame game) {
        this.game = game;
        small_image = new Texture("Tank3.png");
        ...
        small_image1 = new Texture("t3.png");
        ...
        small_image2 = new Texture("Tank2.png");
...
//        backgroundTexture = new TextureRegion(backgroundImage, 0, 0, 840, 630);
    ...
    public void render(float delta) {
        ...
        game.batch.draw(small_region, 100, -45);
        game.batch.draw(small_region1, 500, 43);
        game.batch.draw(small_region2, 890, 81);
...
//        stage.draw();
        ...
        button1.addListener(new ClickListener(){
            ...
            public void clicked(InputEvent event, float x, float y) {
                ...
                game.setScreen(new choose_tank2(game));
//                stage.clear();
//                popout_missile();
            }
        });
...
//                System.out.println("this is clicked");
                game.setScreen(new final_game_screen_copy(game,"t3.png","t3_inverse.png","missile_clipdrop-background-removal.png"));
            }
        });
