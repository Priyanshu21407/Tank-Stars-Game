...
// normal
public class choose_tank extends ScreenAdapter implements Screen {
    ...
    public choose_tank(MyGdxGame game) {
        this.game = game;
        small_image = new Texture("t3.png");
        ...
        small_image1 = new Texture("Tank2.png");
        ...
        small_image2 = new Texture("Tank3.png");
...
//        backgroundTexture = new TextureRegion(backgroundImage, 0, 0, 840, 630);
    ...
    public void render(float delta) {
        ...
        game.batch.draw(small_region, 100, 25);
        game.batch.draw(small_region1, 500, 25);
        game.batch.draw(small_region2, 890, 25);
...
//                System.out.println("this is clicked");
                game.setScreen(new final_game_screen_copy(game,"Tank2.png","Tank2_inverse.png","missile_clipdrop-background-removal.png"));
            }
        });
